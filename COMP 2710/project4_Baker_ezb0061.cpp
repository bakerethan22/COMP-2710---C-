//Ethan Baker
//ezb0061@auburn.edu
//project4_Baker_ezb0061.cpp
//
//lines 24-30 used to define variables and create node structure.
//lines 33-48 used to create initial three questions.
//lines 50-140 used to create questions, add them to question list, and ask them to player, and total points.
//lines 143-176 used for test method.
//lines 178-210 used for the main method.
//
//Used stackoverflow.com for how to use stdlib.h, assert.h, and algorithm.
// as how to implement test cases and use a continue feature.
//
//Compilation instructions: Use "g++ project4_Baker_ezb0061.cpp" to compile code
...
//quiz - initial three questions input into list
...
int main() {
   ...
   cout << "How many questions would you like to answer? (All of them is 3 + user inputted) " << endl;
