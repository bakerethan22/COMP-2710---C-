...
int main(int argc, char *argv[])
{
   ...
   pthread_cond_init(&condc,0);            // initialize the condition varible for consumer
   pthread_cond_init(&condp,0);            // initialize the condition varible for producer
